...
#lee por cada fila del archivo la estaci�n que se analiza, se fija si es liviano y suma los pasos a en la 2da columna los pasos.
...
title ("CANTIDAD DE PASOS DE VEHICULOS LIVIANOS POR ESTACI�N");
set(gca,'fontsize',12);
set(gca,'XTick',1:24);
xlabel ("Estaciones");
...
title ("CANTIDAD DE PASOS DE VEHICULOS PESADOS POR ESTACI�N");
set(gca,'fontsize',12);
set(gca,'XTick',1:24);
xlabel ("Estaciones");
ylabel ("Cantidad de pasos");
